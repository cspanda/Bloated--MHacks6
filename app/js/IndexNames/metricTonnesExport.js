...
var metricTonnesIndices = ['CNEVDF', 'CNEVREPD', 'GRINCORN', 'GRINSOYB', 'GRINWHET', 'SALECNUM', 'SALECORN', 'SALECOTT', 'SALESCML', 'SALESOYB', 'SALESOYM', 'SALESOYO', 'SALESYBN', 'SALESYOL', 'SALEWEAL', 'SALEWHET'];
...
for(var i=0; i<yearsNeeded; i++)//iterating through the years.
{
	...
	var END = YEAR + '-12-31';
		_.forEach(metricTonnesIndices, function(name) {//pushes into that year in sequence.
			params[i].push({
				TableName: YEAR,
